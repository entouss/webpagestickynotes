...
getURI: function(noProtoHost) {
			...
			if (!self.source || noProtoHost) {
				...
				self.source = s;
				self.source = 'tinymce/'+self.source;
				if (!noProtoHost) {
					self.source = chrome.extension.getURL(self.source);
				}
			}
